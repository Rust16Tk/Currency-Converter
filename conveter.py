...
# Form implementation generated from reading ui file 'conveter.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setStyleSheet("background-color: #169dbe")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.label = QtWidgets.QLabel(self.frame)
        self.label.setGeometry(QtCore.QRect(115, 10, 251, 41))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(110, 60, 261, 171))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("lr.png"))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "КОНВЕНТОР ВАЛЮТ"))
        self.pushButton.setText(_translate("MainWindow", "КОНВЕРТОР"))
